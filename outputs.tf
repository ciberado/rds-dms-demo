...
output "main_db_instance_address" {
  ...
  value       = module.main.db_instance_address
}

output "main_db_instance_arn" {
  description = "The ARN of the RDS instance"
  value       = module.main.db_instance_arn
}

output "main_db_instance_availability_zone" {
  description = "The availability zone of the RDS instance"
  value       = module.main.db_instance_availability_zone
}

output "main_db_instance_endpoint" {
  description = "The connection endpoint"
  value       = module.main.db_instance_endpoint
}

output "main_db_instance_engine" {
  description = "The database engine"
  value       = module.main.db_instance_engine
}

output "main_db_instance_engine_version_actual" {
  description = "The running version of the database"
  value       = module.main.db_instance_engine_version_actual
}

output "main_db_instance_hosted_zone_id" {
  description = "The canonical hosted zone ID of the DB instance (to be used in a Route 53 Alias record)"
  value       = module.main.db_instance_hosted_zone_id
}

output "main_db_instance_id" {
  description = "The RDS instance ID"
  value       = module.main.db_instance_id
}

output "main_db_instance_resource_id" {
  description = "The RDS Resource ID of this instance"
  value       = module.main.db_instance_resource_id
}

output "main_db_instance_status" {
  description = "The RDS instance status"
  value       = module.main.db_instance_status
}

output "main_db_instance_name" {
  description = "The database name"
  value       = module.main.db_instance_name
}

output "main_db_instance_username" {
  description = "The main username for the database"
  value       = module.main.db_instance_username
  sensitive   = true
}

output "main_db_instance_password" {
  description = "The database password (this password may be old, because Terraform doesn't track it after initial creation)"
  value       = module.main.db_instance_password
  sensitive   = true
}

output "main_db_instance_port" {
  description = "The database port"
  value       = module.main.db_instance_port
}

output "main_db_subnet_group_id" {
  description = "The db subnet group name"
  value       = module.main.db_subnet_group_id
}

output "main_db_subnet_group_arn" {
  description = "The ARN of the db subnet group"
  value       = module.main.db_subnet_group_arn
}

output "main_db_instance_cloudwatch_log_groups" {
  description = "Map of CloudWatch log groups created and their attributes"
  value       = module.main.db_instance_cloudwatch_log_groups
}
